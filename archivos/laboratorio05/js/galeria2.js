    ...
    abrirmodal[i].addEventListener("click", function () {
        ...
        switch (modalid) {
            case "modal1":
                ...
                imagenmodal.setAttribute("src", "img/Huacachina-noche.jpg");
            ...
            case "modal2":
                ...
                imagenmodal.setAttribute("src", "img/leopardos.jpg");
            ...
            case "modal3":
                ...
                imagenmodal.setAttribute("src", "img/auto8.jpg");
            ...
            case "modal4":
                ...
                imagenmodal.setAttribute("src", "img/banner.jpg");
...
document.addEventListener("click", (e) => {
    if (e.target == document.querySelector(".modal .is-visible")) {
        document.querySelector(".modal is-visble").classList.remove(isVisible);
    }
});